    ...
    <div className="space-y-6">
      ...
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink asChild>
              <Link href={`/dashboard/organisation/${orgId}/projects/${projectId}/teams`}>Teams</Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbLink asChild>
              <Link href={`/dashboard/organisation/${orgId}/projects/${projectId}/teams/${teamId}`}>Team Overview</Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator />
          <BreadcrumbItem>
      ...
      <div className="flex flex-wrap gap-2">
        <Button variant="outline" size="sm" asChild>
          <Link href={`/dashboard/organisation/${orgId}/projects/${projectId}/teams/${teamId}`}>
            <ArrowLeft className="w-4 h-4 mr-2" />
            Team Overview
          </Link>
        </Button>
        <Button variant="outline" size="sm" asChild>
          <Link href={`/dashboard/organisation/${orgId}/projects/${projectId}/teams/${teamId}/boards`}>
            <Kanban className="w-4 h-4 mr-2" />
            Boards
          </Link>
        </Button>
        <Button variant="outline" size="sm" asChild>
          <Link href={`/dashboard/organisation/${orgId}/projects/${projectId}/teams/${teamId}/clients`}>
