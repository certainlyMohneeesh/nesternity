...
export default function TeamOverviewPage({ params }: { params: Promise<{ id: string; projectId: string; teamId: string }> }) {
  const { id: orgId, projectId, teamId } = use(params);
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button asChild variant="outline">
            <Link href={`/dashboard/organisation/${orgId}/projects/${projectId}/teams/${teamId}/boards`}>Boards</Link>
          </Button>
          <Button asChild variant="outline">
            <Link href={`/dashboard/organisation/${orgId}/projects/${projectId}/teams/${teamId}/clients`}>Clients</Link>
          </Button>
          <Button asChild variant="outline">
            <Link href={`/dashboard/organisation/${orgId}/projects/${projectId}/teams/${teamId}/settings`}>Settings</Link>
          </Button>
        </div>
      </div>
