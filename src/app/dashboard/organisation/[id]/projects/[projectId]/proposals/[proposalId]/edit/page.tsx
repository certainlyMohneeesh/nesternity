...
export default async function EditProposalPage({ params }: Props) {
  const { id: orgId, projectId, proposalId } = await params;
  ...
  if (!user) {
    redirect(`/auth/login?returnUrl=/dashboard/organisation/${orgId}/projects/${projectId}/proposals/${proposalId}/edit`);
  }
  ...
  if (proposal.status !== "DRAFT") {
    redirect(`/dashboard/organisation/${orgId}/projects/${projectId}/proposals/${proposalId}`);
  }
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink href={`/dashboard/organisation/${orgId}/projects/${projectId}/proposals/${proposalId}`}>
              {proposal.title}
            </BreadcrumbLink>
          </BreadcrumbItem>
          <BreadcrumbSeparator>
